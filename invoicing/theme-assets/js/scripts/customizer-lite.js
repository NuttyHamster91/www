...
(function(window, document, $) {
    ...
    ****************************************/
    ...
    var element = $('#sidebar-color-option1');
    if(document.cookie = "dark=on"){
    ...
    var menuBackground = document.querySelector('#sidebar-color-option1');
    $('#sidebar-color-option1').on('change',function(){
