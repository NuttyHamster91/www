		...
		<form method="post" id="create_invoice">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right">
    			    ...
    			    <div class="col-xs-6">
				        <div class="form-group" id="invoice_reference">
					        <input type="text" class="form-control required" name="invoice_reference" placeholder="Enter Job Reference / PO / Order Number" >
    					</div>
    				</div>
