            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        <?php if (!FM_READONLY): ?>
                            <b class="ms-2"><a href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-external-link-square"></i> <?php echo lng('Open') ?></a></b>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a href='../'>Home - <i class='fa fa-home' aria-hidden='true' title='Go Home...'></i></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a href='?p='><i class='fa fa-backward' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
...
<p><br><br>  - All Files In This Area Are Visible To Any Registered User Of The Site - Do Not Upload Any Personal Or Sensitive Information That You Would Not Want Others To See !!
<br>This Area will have improvements made - Private file areas will be added - Anything else you want added? <a href="../">Get in touch with Admin</a></p>
<div id="wrapper" class="container-fluid">
    <!-- New Item creation -->
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = '. -   File Manager - All Files Are Public -';
