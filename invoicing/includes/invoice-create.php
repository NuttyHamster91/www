...
$(function () {
  ...
  $("#customer").val(details[0]);
  $("#customer_email_1").val(details[1]);
  $("#customer_email_2").val(details[2]);
  $("#customer_name_2").val(details[3]);
  $("#customer_address_1").val(details[4]);
  $("#customer_address_2").val(details[5]);
  $("#customer_town").val(details[6]);
  $("#customer_county").val(details[7]);
  $("#customer_postcode").val(details[8]);
  $("#customer_phone").val(details[9]);
  $("#customer_ship_name").val(details[10]);
  $("#customer_ship_address_1").val(details[11]);
  $("#customer_ship_address_2").val(details[12]);
  $("#customer_ship_town").val(details[13]);
  $("#customer_ship_county").val(details[14]);
  $("#customer_ship_postcode").val(details[15]);
  $("#customer_ship_phone").val(details[9]);
})
