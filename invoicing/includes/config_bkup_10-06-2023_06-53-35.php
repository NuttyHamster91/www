...
define('COMPANY_ADDRESS_1', 'Address L1');
define('COMPANY_ADDRESS_2', 'Address L2');
define('COMPANY_ADDRESS_3', 'Address L3');
define('COMPANY_COUNTY', 'Devon');
define('COMPANY_POSTCODE', 'TQ1 1QW');
define('COMPANY_CONTACT_1', '07123123456');
define('COMPANY_CONTACT_2', '');
define('COMPANY_EMAIL', 'info@andrewsbc.co.uk');
...
// Other Settings
define('INVOICE_PREFIX', 'ABC-INV-'); // Prefix at start of invoice - leave empty '' for no prefix
define('INVOICE_INITIAL_VALUE', '2524'); // Initial invoice order number (start of increment)
...
define('PAYMENT_SORT', '00-11-22'); // Sort Code
define('PAYMENT_ACCTNO', '29384756'); // Acct Number
define('PAYMENT_DETAILS', 'Simon H Company.<br>Bank: Lloyds<br>Sort Code: 00-11-22<br>Account Number: 29384756'); // Payment information
define('FOOTER_NOTE', 'Full Ts&Cs available on our website.'); // 
