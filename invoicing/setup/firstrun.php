    ...
    <div class="body d-md-flex align-items-center justify-content-between">
        <div class="box-1 d-flex flex-column">
            <div class="ml-1 mt-0 center_div">
                <p class="mb-0 h-1">First Run - Settings</p>
                <div class="d-flex flex-column center_div">
                    <p class="text-muted mb-1">All Fields are Required !<? echo '<br>' . $pVar?></p>
                    <form method="POST" action="initsetup.php">
                        <div class="form-group">
                            <label>Database Name<br></label><br>
                            <input class="form-control" type="text"  id="db_name" name="db_name" placeholder="Database Name" required>
                        </div>
                        <div class="form-group">
                            <label>Database Username<br></label><br>
                            <input class="form-control" type="text" id="db_user" name="db_user" placeholder="Database Username" required>
                        </div>
                        <div class="form-group">
                            <label>Database Password<br></label><br>
                            <input class="form-control" type="password" id="db_pass" name="db_pass" placeholder="Database Password" required>
                        </div>
                        <div class="form-group">
                            <label>Your Company Name<br></label><br>
                            <input class="form-control" type="text" id="comp_name" name="comp_name" placeholder="Company Name " required>
                        </div>
                        <div class="form-group">
                            ...
                            <?php $Zone = TIMEZONE;
                                        ...
                                        echo "<select class='form-control' name='TIMEZONE' id='TIMEZONE' required>";
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="web_add" name="web_add" placeholder="E.G. Localhost or microsoft.com " required>
                        </div>
                </div>
            </div>
        </div>
